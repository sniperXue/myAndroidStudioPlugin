...
public class EventsList extends JPanel implements EventReader.EventListener, ComponentListener {
    ...
    public EventsList() {
        ...
        generate.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //T14.class actionPerformed from EventsList.java
                Messages.showMessageDialog("T14.line 115 from EventsList.java", "Information", Messages.getInformationIcon());
                generate();
            }
        });
        tmp = new JPanel();
        ...
        save.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //T12.class actionPerformed from EventsList.java
                Messages.showMessageDialog("T12.line 145 from EventsList.java", "Information", Messages.getInformationIcon());
                save();
            }
        });
        ...
        load.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //T13.class actionPerformed from EventsList.java
                Messages.showMessageDialog("T13.line 154 from EventsList.java", "Information", Messages.getInformationIcon());
                load();
            }
        });
